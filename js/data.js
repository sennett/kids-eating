var restaurants = [{
    ...
    name: "Family Room Cafe",
    address: "Calle Vergós 55 (plaza), 08017 Barcelona",
    lat: 41.396830,
    lng: 2.126869,
    summary: "Great play area. Small but tasty menu.",
    amenities: {
    ...
    name: "Bitacora tapas",
    address: "Plaça de la Unió, 24, 08005 Barcelona",
    lat: 41.400914,
    lng: 2.204891,
    ...
    address: "Plaça Revolució de Setembre 1868, 15, 08012 Barcelona",
    lat: 41.402534,
    lng: 2.158083,
    ...
    name: "Café Lennon",
    address: "Carrer de Puigmartí, 35, 08012 Barcelona",
    lat: 41.402840,
    lng: 2.161110,
    ...
    name: "Kasparo",
    address: "Plaça de Vicenç Martorell, 4, 08001 Barcelona",
    lat: 41.384469,
    lng: 2.168990,
    blue: true
}, {
